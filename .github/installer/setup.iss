; VxKex Installer Script for Inno Setup
; 版本号通过命令行参数 /DMyAppVersion="x.x.x" 传入

#define MyAppName "VxKex"
; MyAppVersion 将通过命令行 /D 参数动态传入
#ifndef MyAppVersion
  #define MyAppVersion "1.1.3.1428"
#endif
...
SetupIconFile=VxKex\KexCfg\KexCfg.ico
...
[Files]
; x64 文件
Source: "VxKex\PackageRoot\x64\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs; Check: Is64BitInstallMode
; x86 文件
Source: "VxKex\PackageRoot\x86\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs; Check: not Is64BitInstallMode
; 文档
Source: "VxKex\PackageRoot\*.md"; DestDir: "{app}"; Flags: ignoreversion
Source: "VxKex\PackageRoot\*.txt"; DestDir: "{app}\Documentation"; Flags: ignoreversion recursesubdirs
